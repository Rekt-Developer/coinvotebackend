...
router.get('/updateCoinData', checkAuthorization, (req, res) => {
  ...
  var config = {
    method: 'get',
    maxBodyLength: Infinity,
    url: 'https://coin-ab637-default-rtdb.firebaseio.com/coins.json?orderBy="ownerId"&equalTo="Ispu8BsHwKdmCkAjNwSdZbCjyWn1"',
    headers: { }
  };
    ...
    Object.entries(result).forEach((entry) => {
      ...
      axios.post('https://api.livecoinwatch.com/coins/single', {
        ...
        headers: {
          ...
          'x-api-key': 'e0264ff4-fd03-4d6f-8d67-d5a3fd6b1d54',
        },
      })
      .then((response) => {
